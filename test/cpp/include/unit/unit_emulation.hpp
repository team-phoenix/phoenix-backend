...
//    void should_emit_video_and_audio_frames() {

//        subject->init( workingCorePath, workingGamePath, "2d" );

//        QSignalSpy audioFrameSpy( subject, &AbstractEmulator::audioFrameReady );
//        QSignalSpy videoFrameSpy( subject, &AbstractEmulator::videoFrameReady );

//        subject->run();

//        QCOMPARE( audioFrameSpy.count(), 1 );
//        QCOMPARE( videoFrameSpy.count(), 1 );
